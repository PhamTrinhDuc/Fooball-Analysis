...
class SpeedAndDistanceEstimator:
    ...
    def add_speed_and_distance_to_tracks(self, tracks):
        ...
        for object, object_tracks in tracks.items():
            ...
            for frame_num in range(0, number_of_frames, self.NUM_FRAME_WINDOWN):
                last_frame = min(frame_num+self.NUM_FRAME_WINDOWN, number_of_frames-1 )
